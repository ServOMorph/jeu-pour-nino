...
v1.31. **Phase 1 (Matériaux typés) close** : gating de minage data-driven via `weapons.json`/`RunState`, run manuel complet validé (minage tiers 2/3, craft, HUD, menu dev).
GUT vert (`23/23`), démarrage headless OK y compris `biome1`.
Sprites `minerai_abyssal` (`ore_abyssal.png`) et `fer` (`ore_iron.png`) intégrés et corrects.
Prochaine étape : Phase 2 — Grimoire, Points de Compétence, Craft v3.
