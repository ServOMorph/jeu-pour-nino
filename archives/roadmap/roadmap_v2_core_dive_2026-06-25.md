...
## v2.1 — Retours playtest & difficulté

Objectif : corriger les principaux retours de test avant de passer à la v3. Le jeu doit être plus tendu, mieux rythmé, et éviter que l'atelier devienne une zone morte trop facile.

- [ ] Augmenter la difficulté générale du run : ennemis, pression, dégâts, rythme ou coût des erreurs.
- [ ] Permettre d'avoir plusieurs potions de soin en stock au lieu d'une seule.
- [ ] Retirer de l'établi les améliorations d'équipement déjà dépassées : après achat de l'épée cuivre, l'épée bois ne doit plus être craftable. Même règle pour toutes les futures améliorations.
- [ ] Ajouter un bouton pour courir plus vite.
- [ ] Faire respawn les mobs pour éviter que le retour à l'atelier soit vide et trop facile.
- [ ] Implémenter la monnaie du jeu.
- [ ] Rendre le boss plus difficile.

**Jalon** : v2.1 jouable avec une vraie tension de run, plusieurs soins possibles, une progression d'équipement propre, des ennemis qui maintiennent la pression, une monnaie fonctionnelle et un boss plus exigeant.
