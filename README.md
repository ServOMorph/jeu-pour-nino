...
Une premiere base 3D locale SF3D du personnage est disponible sous `game_art/models/sf3d_player_v1/` et son import dans Blender est valide. La reprise est guidee par `game_art/models/BLENDER_SF3D_WORKFLOW.md` et utilise directement `D:\blender\blender.exe`; le prochain travail reste le nettoyage, les materiaux, le rig et les rendus de controle.
La prochaine etape jeu reste de produire des poses de course plus coherentes, puis de verifier le HUB et valider J1 avant la Phase 4.
