...
Une premiere base 3D locale SF3D du personnage est disponible sous `game_art/models/sf3d_player_v1/` et son import dans Blender est valide. Elle n'est pas integree au jeu : le prochain travail 3D est le nettoyage du maillage, les materiaux, le rig et les rendus de controle a partir de references multi-vues plus precises.
